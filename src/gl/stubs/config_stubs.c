...
GLenum map_caml_long(int v) 
{
  switch(v)
  {
    ...
    case 3  : return GL_DEBUG_OUTPUT;
    case 4  : return GL_DEBUG_OUTPUT_SYNCHRONOUS;
    case 5  : return GL_DEPTH_CLAMP;
    case 6  : return GL_DEPTH_TEST;
    case 7  : return GL_DITHER;
    case 8  : return GL_FRAMEBUFFER_SRGB;
    case 9  : return GL_LINE_SMOOTH;
    case 10 : return GL_MULTISAMPLE;
    case 11 : return GL_POLYGON_OFFSET_FILL;
    case 12 : return GL_POLYGON_OFFSET_LINE;
    case 13 : return GL_POLYGON_OFFSET_POINT;
    case 14 : return GL_POLYGON_SMOOTH;
    case 15 : return GL_PRIMITIVE_RESTART;
    case 16 : return GL_PRIMITIVE_RESTART_FIXED_INDEX;
    case 17 : return GL_RASTERIZER_DISCARD;
    case 18 : return GL_SAMPLE_ALPHA_TO_COVERAGE;
    case 19 : return GL_SAMPLE_ALPHA_TO_ONE;
    case 20 : return GL_SAMPLE_COVERAGE;
    case 21 : return GL_SAMPLE_SHADING;
    case 22 : return GL_SAMPLE_MASK;
    case 23 : return GL_SCISSOR_TEST;
    case 24 : return GL_STENCIL_TEST;
    case 25 : return GL_TEXTURE_CUBE_MAP_SEAMLESS;
    case 26 : return GL_PROGRAM_POINT_SIZE;
